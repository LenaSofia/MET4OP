...
DF_completo = pd.read_csv("D:/UBA/4to Cuarto año/Segundo cuatrimestre/Metodología de análisis en opinión pública/GITHUB_ANTERIOR/examenes/TP2/segunda_parte/Lena/DF_completo.csv")
...
DF_completo_voto_obligatorio = DF_completo_voto_obligatorio.drop(DF_completo_voto_obligatorio[DF_completo['P03'] > 70].index)
...
# Total
DF_para_corr = DF_completo[["VOTOS_FIT_PRES", "PORCENTAJE_FIT_PRES", "P03"]]

# Mayores de 16
DF_para_corr_mayores = DF_completo_mayores_16[["VOTOS_FIT_PRES", "PORCENTAJE_FIT_PRES", "P03"]]

# Mayores de 18 y menores de 70
DF_para_corr_oblig = DF_completo_voto_obligatorio[["VOTOS_FIT_PRES", "PORCENTAJE_FIT_PRES", "P03"]]
