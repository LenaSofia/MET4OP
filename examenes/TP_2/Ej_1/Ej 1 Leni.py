...
print(resultCABA_pres_fit)


resultCABA_pres_fit.reset_index(inplace=True)
print(resultCABA_pres_fit)

#¿Capaz estaría bueno borrar el index original (3, 17, 31...)?
...
#%%
# Resultados del FIT en cada mesa solo para Diputados Nacionales
...
print(comparacion_fit_pres_dip)
...
print(comparacion_blanco_pres_fit_dip)
#%%
# Pendiente: 
